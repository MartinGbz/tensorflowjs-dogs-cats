...
(a.on("message",function(d){a.onmessage({data:d})}),a.on("error",function(d){a.onerror(d)}),a.on("detachedExit",function(){}));a.postMessage({cmd:"load",urlOrBlob:w.mainScriptUrlOrBlob||_scriptDir,wasmMemory:k,wasmModule:ra})},ib:function(){var a=ma("ort-wasm-simd-threaded.worker.js");S.Pa.push(new Worker(a))},mb:function(){0==S.Pa.length&&(S.ib(),S.ob(S.Pa[0]));return S.Pa.pop()}};w.PThread=S;function U(a){for(;0<a.length;)a.shift()(w)}function Wa(a){var b=Xa();a=a();W(b);return a}
